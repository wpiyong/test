...
namespace ImageProcessing.ViewModels
{
    ...
    public class ControlViewModel : ViewModelBase
    {
        public ControlViewModel()
        {
            ...
            //Method = "FancyColor";
            ProcMethods = new ObservableCollection<string>() { "Canny", "AbsDiff", "GrabCut", "BGSub", "FancyColor", "Glare" };
        ...
        {
            uri = new Uri("..\\..\\..\\Images\\pearl.png", UriKind.Relative);

            name = System.IO.Path.GetFileNameWithoutExtension(uri.OriginalString);
            BitmapImage bitmapF = new BitmapImage(uri);
            BitmapImage bitmapB = new BitmapImage(new Uri("..\\..\\..\\Images\\b0.png", UriKind.Relative));
